 ...
 * @author balle
 */
public class Carro extends Vehiculo implements IRadio, IControlVelocidad, IControlLuces {

    public Carro(int modelo, String placa, String marca, String color) {
    ...
    @Override
    public void meterCD() {
        System.out.println("Introduciendo CD...");
    }

    @Override
    public void expulsarCD() {
        System.out.println("Expulsando CD...");
    }
